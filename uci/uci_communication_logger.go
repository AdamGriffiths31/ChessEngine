...
// CommunicationLogger captures all UCI input/output for debugging
...
func (ucl *CommunicationLogger) LogSessionStart() {
	if ucl == nil {
		return
	}
...
func (ucl *CommunicationLogger) LogIncoming(command string) {
	if ucl == nil {
		return
	}
...
func (ucl *CommunicationLogger) LogOutgoing(response string) {
	if ucl == nil {
		return
	}
...
func (ucl *CommunicationLogger) LogPositionCommand(command string) {
...
func (ucl *CommunicationLogger) LogBestMove(response string) {
...
func (ucl *CommunicationLogger) LogError(context string, err error) {
	if ucl == nil {
		return
	}
...
func (ucl *CommunicationLogger) LogGameTermination(reason string) {
	if ucl == nil {
		return
	}
...
func (ucl *CommunicationLogger) LogDebugInfo(info string) {
	if ucl == nil {
		return
	}
...
func (ucl *CommunicationLogger) Close() {
	if ucl == nil {
		return
	}
	...
	if ucl.logFile != nil {
		...
		ucl.logger.Println("=====================================")
		_ = ucl.logFile.Close() // Ignore error on close for logging cleanup
	}
}

// isPotentiallyIllegal checks if a move might be problematic
func (ucl *CommunicationLogger) isPotentiallyIllegal(move string) bool {
...
func (ucl *CommunicationLogger) WrapWriter(original io.Writer) io.Writer {
	if ucl == nil {
		return original
	}
