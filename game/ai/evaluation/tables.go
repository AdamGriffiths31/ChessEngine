...
var RookTable = [64]int{
	0, 0, 0, 5, 5, 0, 0, 0, // rank 1 (white back rank)
	...
	0, 0, 0, 0, 0, 0, 0, 0, // rank 8 (black back rank)
}
...
var KingTable = [64]int{
	20, 30, 10, 0, 0, 10, 30, 20, // rank 1 (white back rank)
	...
	-30, -40, -40, -50, -50, -40, -40, -30, // rank 8 (black back rank)
}
