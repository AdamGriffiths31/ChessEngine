...
func TestEvaluationSymmetry(t *testing.T) {
	// Not parallel: evaluator.Evaluate() routes through
	// evaluatePawnStructure(), which reads/writes the package-level
	// PawnHashTable cache without synchronization (see
	// TestEvaluatePawnStructure in pawn_evaluation_test.go).
